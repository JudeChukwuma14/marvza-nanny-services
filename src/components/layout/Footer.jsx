...
const SOCIALS = [
  {
    icon: FacebookIcon,
    label: "Facebook",
    href: "https://www.facebook.com/share/19WphTo14D/?mibextid=wwXIfr",
  },
  {
    icon: InstagramIcon,
    label: "Instagram",
    href: "https://www.instagram.com/marvzanannies?utm_source=qr",
  },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div>
                <span className="text-[16px] font-bold font-serif text-white leading-tight block">
                  Marvza
                </span>
                <span className="text-[11px] text-white/50 leading-tight block">
                  Private Nannies & Mannies
                </span>
              </div>
            </div>
            <p className="text-sm text-white/60 leading-relaxed mb-6 max-w-xs">
              A premium London agency for private nannies and mannies,
              connecting trusted, experienced childcare professionals with
            ...
            <div className="flex flex-col gap-3 mb-6">
              <a
                href="mailto:Hello@marvza.com"
                className="flex items-center gap-2.5 text-sm text-white/60 hover:text-accent transition-colors group"
              >
                <Mail
                  size={14}
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/40">
            © {year} Marvza Ltd. All rights reserved. Registered in England &
            Wales.
          </p>
